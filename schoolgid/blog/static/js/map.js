...
const roomsInfo = {
    ...
    "Кабинет 112": "Кабинет старших классов.",
    "Кабинет 111": "Кабинет старших классов.",
    "Кабинет 110": "Кабинет русского языка и литературы.<br> Здесь изучают грамматику и пунктуацию.",
    "Кабинет 109": "Кабинет старших классов.",
    "Кабинет 108(М)": "Кабинет технологии у мальчиков.",
    "Кабинет 108(Д)": "Кабинет технологии у девочек.",
    ...
    "1": new ol.layer.Vector({
        source: new ol.source.Vector({
            features: [
                ...
                createMarker([290, 224], "Кабинет 112"),
                createMarker([380, 224], "Кабинет 111"),
                createMarker([470, 224], "Кабинет 110"),
                createMarker([570, 224], "Кабинет 109"),
                createMarker([700, 224], "Кабинет 108(Д)"),
                createMarker([700, 274], "Кабинет 113"),
